...
class FormValidation implements ValidationInterface
{
    ...
    {
        // Sort required to the front, so that we always check it first.
        // If a field is required and there's no value, we don't need to
        // bother checking any of the remaining rules.
        usort($fieldRules, fn ($rule) => $rule === 'required' ? -1 : 1);
